...
const GREETINGS = {
  ...
  de: { morning: "Guten Morgen", afternoon: "Guten Tag", evening: "Guten Abend", night: "Noch wach?" },
  it: { morning: "Buongiorno", afternoon: "Buon pomeriggio", evening: "Buona sera", night: "Ancora sveglio?" },
  fr: { morning: "Bonjour", afternoon: "Bon après-midi", evening: "Bonsoir", night: "Toujours réveillé·e ?" },
  es: { morning: "Buenos días", afternoon: "Buenas tardes", evening: "Buenas noches", night: "¿Aún despierto?" }
};
...
const HERO_COPY = {
  ...
  de: {
    ...
    accent: "Salzburg · Hotellerie"
  },
  it: {
    title: "Ciao, sono Amir Ismaili.",
    subtitle:
      "Apprendista al front office all’HYPERION Hotel Salzburg, con esperienza tra reception e servizio e un approccio concreto e tranquillo.",
    accent: "Salisburgo · Ospitalità"
  },
  fr: {
