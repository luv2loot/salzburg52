      ...
      >
        ...
        <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.p className="hero-subtitle" variants={itemVariants}>
            Mein professionelles Portfolio als Lehrling im HYPERION Hotel Salzburg. 
...
function PhilosophySection() {
  ...
  const philosophyItems = [
    {
      text: "Aufmerksames Zuhören und durchdachte Antworten auf Gästewünsche",
      icon: (
    ...
    {
      text: "Klare Kommunikation und organisierte Informationsvermittlung",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      text: "Bewahrung von Ruhe und Eleganz in allen Situationen",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      text: "Ehrliche, höfliche Interaktionen statt oberflächlicher Höflichkeitsfloskeln",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section ref={ref} className="app-shell" style={{ marginBottom: "2rem", position: "relative" }}>
      ...
      >
        ...
        <p style={{ color: "var(--color-muted)", maxWidth: "500px", margin: "0 auto" }}>
          Die Grundsätze, die meinen Ansatz in der Gastfreundschaft leiten.
        </p>
      </motion.div>
...
function AboutSection() {
  ...
  return (
    ...
    >
      <FloatingOrb size={200} color="rgba(139, 92, 246, 0.08)" blur={70} top="10%" right="-5%" delay={1} duration={28} />
      ...
      <div style={{
        ...
        <ContentCard title="Meine Geschichte" index={0}>
        ...
        <ContentCard title="Mein Ansatz" index={1}>
          <p>
      ...
      >
        ...
        >
          <h3 style={{ fontSize: "1.4rem", fontWeight: 600, marginBottom: "1rem" }}>
            Mein Weg im HYPERION
          </h3>
          <p style={{ color: "var(--color-muted)", lineHeight: 1.7, marginBottom: "1.5rem", maxWidth: "600px" }}>
            Meine Ausbildung im HYPERION Hotel Salzburg war transformativ—von den Grundlagen des Rezeptionsbetriebs 
            bis zum tiefen Verständnis von Luxus-Gastfreundschaft. Jeder Tag bringt neue Möglichkeiten zu wachsen 
            und meine Fähigkeiten zu verfeinern.
          </p>
          <motion.a
            href={`/${LANG}/journey`}
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            <p>
              <strong style={{ color: "var(--color-text)" }}>E-Mail:</strong>{" "}
              <motion.a
