...
const THEME_META = {
  ...
  auto: {
    label: "Auto (Zeit)",
    description: "Hell 6-18 Uhr, nachts dunkel",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  light: {
    label: "Hell",
    description: "Sauber, helles Erscheinungsbild",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  dark: {
    label: "Dunkel",
    description: "Schonend für die Augen",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  "salzburg-night": {
    label: "Salzburg Nacht",
    description: "Lila/blaue Abendstimmung",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <main>
        ...
        >
          <div className="settings-page-header">
            ...
            <h1 className="settings-page-title">Einstellungen</h1>
            <p className="settings-page-subtitle">
              Passen Sie Ihr Erlebnis mit Sprach-, Design- und Barrierefreiheitsoptionen an.
            </p>
          </div>
        </motion.section>
        ...
        <section className="app-shell">
          <ScrollReveal direction="up" delay={0}>
            ...
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Sprache</h2>
            </div>
          ...
          <ScrollReveal direction="up" delay={0.1}>
            ...
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Erscheinungsbild</h2>
            </div>
            <p className="settings-page-card-desc">
              Wählen Sie ein Design, das zu Ihrem Stil passt.
            </p>
          ...
          <ScrollReveal direction="up" delay={0.2}>
            ...
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Barrierefreiheit</h2>
            </div>
            <p className="settings-page-card-desc">
              Passen Sie Einstellungen an, um Ihr Surferlebnis zu verbessern.
            </p>

            <div className="settings-page-option-row">
              <div className="settings-page-option-info">
                <span className="settings-page-option-label">Schriftgröße</span>
                <span className="settings-page-option-hint">
                  Erhöhen Sie die Textgröße für bessere Lesbarkeit
                </span>
              </div>
            ...
            <div className="settings-page-option-row">
              <div className="settings-page-option-info">
                <span className="settings-page-option-label">Reduzierte Bewegung</span>
                <span className="settings-page-option-hint">
                  Minimieren Sie Animationen und Übergänge
                </span>
              </div>
              <motion.button
                type="button"
