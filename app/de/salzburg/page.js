...
const DINING_RECOMMENDATIONS = {
  "night-2": {
    ...
    venues: [
      "Restaurant Ikarus – 2 Michelin-Sterne",
      "Esszimmer – Feine österreichische Küche",
      "St. Peter Stiftskulinarium – Historisches Ambiente"
    ]
  },
  "night-3": {
    title: "Weinbar-Empfehlungen",
    venues: [
      "Weinstube K+K – Lokale Weine",
      "Vinotek Stöckl – Kuratierte Auswahl",
      "Die Weisse – Österreichische Spezialitäten"
    ]
  },
  "night-6": {
    title: "Beste Dachterrassenbars",
    venues: [
      "IMLAUER Sky – Panoramablick",
      "M32 am Mönchsberg – Festungsblick",
      "Steinterrasse – Historischer Stadtblick"
    ]
  }
};
...
const DAY_ACTIVITIES = [
  {
    id: "day-1",
    title: "Altstadt",
    description: "Historischer UNESCO-Weltkulturerbe Rundgang durch barocke Architektur, charmante Plätze und Jahrhunderte Geschichte in jedem Kopfsteinpflaster.",
    tag: "Walk",
  ...
  },
  {
    ...
    description: "Wunderschöne Barockgärten mit geometrischen Blumenbeeten, Brunnen und dem berühmten Drehort von Sound of Music.",
    tag: "Walk",
  ...
  },
  {
    ...
    description: "Museum im ikonischen gelben Stadthaus, wo Wolfgang Amadeus Mozart 1756 geboren wurde—entdecken Sie sein frühes Leben und musikalisches Genie.",
    tag: "Culture",
  ...
  },
  {
    id: "day-4",
    title: "Getreidegasse",
    description: "Berühmte Einkaufsstraße mit traditionellen kunstvollen Zunftschildern aus Schmiedeeisen, Boutiquen und versteckten Innenhöfen.",
    tag: "Walk",
  ...
  },
  {
    ...
    description: "Panoramablick bei Tag über die Stadt von der ikonischen mittelalterlichen Festung hoch über der Altstadt.",
    tag: "View",
    image: "/images/salzburg_austria_his_c717a1e9.jpg"
  },
  {
    id: "day-6",
    title: "Kaffeehauskultur",
    description: "Traditionelle Wiener Kaffeehäuser mit reichhaltigem Melange, feinem Gebäck und der zeitlosen Kunst österreichischer Cafékultur.",
    tag: "Food",
    image: "/images/professional_hospita_13c23690.jpg"
  },
  {
    id: "day-7",
    title: "Salzach-Spaziergang",
    description: "Malerische Uferpromenade entlang des smaragdgrünen Wassers, die Alt- und Neustadt mit wunderschönen Brückenblicken verbindet.",
    tag: "Walk",
  ...
  },
  {
    id: "day-8",
    title: "Bergausblicke",
    description: "Seilbahn zum Untersberg für atemberaubende Alpenpanoramen nur wenige Minuten vom Stadtzentrum entfernt.",
    tag: "View",
    image: "/images/salzburg_austria_his_ddc72f4b.jpg"
  }
];
...
const NIGHT_ACTIVITIES = [
  {
    id: "night-1",
    title: "Festung bei Nacht",
    description: "Beleuchtete Festungsansichten und Abendkonzerte auf der Hohensalzburg—eine magische Silhouette gegen den Sternenhimmel.",
    tag: "View",
    image: "/images/salzburg_austria_his_c717a1e9.jpg"
  },
  {
    ...
    description: "Michelin-Sterne-Restaurants und lokale Küche—genießen Sie exquisite österreichische Gerichte mit Panoramablick und Kerzenlicht.",
    tag: "Food",
  ...
  },
  {
    id: "night-3",
    title: "Weinbars",
    description: "Gemütliche österreichische Weinverkostungen in intimen Kellern und stilvollen Bars mit lokalem Grüner Veltliner und regionalen Spezialitäten.",
    tag: "Food",
    image: "/images/luxury_hotel_interio_aa4bb2e2.jpg"
  },
  {
    id: "night-4",
    title: "Altstadt in der Dämmerung",
    description: "Magische Atmosphäre mit beleuchteten Straßen, leuchtenden Schaufenstern und dem zeitlosen Charme Salzburgs nach Sonnenuntergang.",
    tag: "Walk",
    image: "/images/salzburg_austria_his_ea8bfaf1.jpg"
  },
  {
    id: "night-5",
    title: "Konzertsäle",
    description: "Salzburger Festspielorte und klassische Musik—erleben Sie Weltklasse-Aufführungen in historischen Konzertsälen.",
    tag: "Music",
    image: "/images/salzburg_austria_mou_6393989e.jpg"
  },
  {
    id: "night-6",
    title: "Dachterrassenbars",
    description: "Stadtblicke unter den Sternen—genießen Sie Cocktails mit Panoramablick auf die beleuchtete Altstadt und Festung.",
    tag: "Nightlife",
    image: "/images/salzburg_cityscape_sunset_view.png"
  },
  {
    id: "night-7",
    title: "Jazzclubs",
    description: "Live-Musikszene in der Altstadt—entdecken Sie intime Veranstaltungsorte mit lokalen und internationalen Jazzkünstlern.",
    tag: "Music",
    image: "/images/luxury_hotel_interio_dd2a3b13.jpg"
  },
  {
    id: "night-8",
    title: "Nachtfotografie",
    description: "Die besten Spots für Abendaufnahmen—fangen Sie die beleuchtete Festung, Spiegelungen auf der Salzach und atmosphärische Straßen ein.",
    tag: "Photo",
    image: "/images/salzburg_austria_his_ddc72f4b.jpg"
  }
];
          ...
          <main className="app-shell">
            ...
            >
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  Dieser Schalter steuert die angezeigten Aktivitäten, unabhängig vom globalen Theme der Website.
                </motion.p>
                ...
                >
                  ...
                  >
                    {isNightMode ? "Erkunden im Mondlicht" : "Entdecken bei Tageslicht"}
                  </motion.span>
                </motion.div>
                ...
                >
                  {isNightMode 
                    ? "Erleben Sie die magische Atmosphäre Salzburgs nach Einbruch der Dunkelheit—beleuchtete Straßen, gemütliche Lokale und zeitlose Schönheit unter den Sternen."
                    : "Entdecken Sie den Charme von Mozarts Geburtsstadt—barocke Architektur, Bergblicke und Jahrhunderte von Kultur in jeder Ecke."}
                </motion.p>
              </div>
            </motion.section>
            ...
            >
              ...
              >
                <h2 style={{
                  ...
                  {isNightMode ? "Nächtliche Favoriten" : "Sehenswerte Ziele"}
                </h2>
                <p style={{
                  fontSize: "1rem",
                  ...
                  {isNightMode 
                    ? "Diese Orte erwachen zum Leben, wenn die Sonne untergeht"
                    : "Die unverzichtbaren Salzburg-Erlebnisse, die Sie nicht verpassen sollten"}
                </p>
              </motion.div>
            ...
            >
              <h3 style={{
                ...
                {isNightMode ? "Bereit, die Nacht zu erkunden?" : "Starten Sie Ihre Salzburg-Reise"}
              </h3>
              <p style={{
                fontSize: "1rem",
                color: isNightMode ? "#e2e8f0" : "#64748b",
                ...
                {isNightMode 
                  ? "Von beleuchteten historischen Stätten bis hin zu gemütlichen Abendlokalen—die nächtliche Magie Salzburgs erwartet Sie."
                  : "Ob Sie wegen der Musik, der Berge oder der Erinnerungen hier sind—Salzburg heißt Sie willkommen."}
              </p>
              <motion.button
