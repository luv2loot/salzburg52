...
export default function ItHomePage() {
  ...
  const featureItems = [
    { icon: featureIcons.experience, text: "Impara dall'esperienza pratica nel servizio di ospitalità di lusso." },
    { icon: featureIcons.insights, text: "Scopri prospettive pratiche sulla creazione di esperienze memorabili per gli ospiti." },
    { icon: featureIcons.explore, text: "Esplora Salisburgo dalla prospettiva dell'ospitalità professionale." }
  ];
      ...
      <main>
        ...
        >
          <div className="surface feature-inner" style={{ padding: "2.5rem" }}>
            ...
            <h2 className="feature-title" style={{ fontSize: "1.8rem", marginBottom: "1rem" }}>Il Mio Percorso Professionale</h2>
