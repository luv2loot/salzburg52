...
const DINING_RECOMMENDATIONS = {
  "night-2": {
    ...
    venues: [
      "Restaurant Ikarus – 2 Stelle Michelin",
      "Esszimmer – Alta Cucina Austriaca",
      "St. Peter Stiftskulinarium – Ambiente Storico"
    ]
  },
  "night-3": {
    title: "Wine Bar Consigliati",
    venues: [
      "Weinstube K+K – Vini Locali",
      "Vinotek Stöckl – Selezione Curata",
      "Die Weisse – Specialità Austriache"
    ]
  },
  "night-6": {
    title: "Migliori Rooftop Bar",
    venues: [
      "IMLAUER Sky – Viste Panoramiche",
      "M32 a Mönchsberg – Vista Fortezza",
      "Steinterrasse – Vista Storica"
    ]
  }
};
          ...
          <main className="app-shell">
            ...
            >
              <h3 style={{
                ...
                {isNightMode ? "Pronto ad esplorare la notte?" : "Inizia il tuo viaggio a Salisburgo"}
              </h3>
              <p style={{
                fontSize: "1rem",
                color: isNightMode ? "#e2e8f0" : "#64748b",
                ...
                {isNightMode 
                  ...
                  : "Che tu sia qui per la musica, le montagne o i ricordi—Salisburgo ti dà il benvenuto."}
              </p>
              <motion.button
