...
const THEME_META = {
  ...
  "salzburg-night": {
    label: "Nuit de Salzbourg",
    description: "Ambiance soirée violet/bleu",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        >
          <div className="settings-page-header">
            ...
            <p className="settings-page-subtitle">
              Personnalisez votre expérience avec les options de langue, de thème et d'accessibilité.
            </p>
          </div>
        </motion.section>
        ...
        >
          <motion.div className="surface settings-page-card" variants={fadeInUp}>
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Langue</h2>
            </div>
          ...
          <motion.div className="surface settings-page-card" variants={fadeInUp}>
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Apparence</h2>
            </div>
            <p className="settings-page-card-desc">
              Sélectionnez un thème qui correspond à votre style.
            </p>
          ...
          <motion.div className="surface settings-page-card" variants={fadeInUp}>
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Accessibilité</h2>
            </div>
            <p className="settings-page-card-desc">
              Ajustez les paramètres pour améliorer votre expérience de navigation.
            </p>

            <div className="settings-page-option-row">
              <div className="settings-page-option-info">
                <span className="settings-page-option-label">Taille de Police</span>
            ...
            <div className="settings-page-option-row">
              <div className="settings-page-option-info">
                <span className="settings-page-option-label">Mouvement Réduit</span>
                <span className="settings-page-option-hint">
