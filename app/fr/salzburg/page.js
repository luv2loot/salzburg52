...
const DAY_ACTIVITIES = [
  {
    id: "day-1",
    title: "Vieille Ville",
    description: "Visite historique du patrimoine mondial de l'UNESCO à travers l'architecture baroque, les places charmantes et des siècles d'histoire dans chaque pavé.",
    tag: "Walk",
    image: "/images/salzburg_austria_his_ea8bfaf1.jpg"
  },
  {
    id: "day-2",
    title: "Palais Mirabell",
    description: "Magnifiques jardins baroques avec parterres géométriques, fontaines et célèbre lieu de tournage de La Mélodie du Bonheur.",
    tag: "Walk",
    image: "/images/salzburg_austria_his_ddc72f4b.jpg"
  },
  {
    id: "day-3",
    title: "Maison Natale de Mozart",
    description: "Musée dans l'emblématique maison jaune où Wolfgang Amadeus Mozart est né en 1756—découvrez sa jeunesse et son génie musical.",
    tag: "Culture",
  ...
  },
  {
    id: "day-4",
    title: "Getreidegasse",
    description: "Célèbre rue commerçante avec enseignes traditionnelles en fer forgé, boutiques et cours cachées menant aux rues parallèles.",
    tag: "Walk",
    image: "/images/salzburg_austria_mou_7fa6ee31.jpg"
  },
  {
    id: "day-5",
    title: "Forteresse Hohensalzburg",
    description: "Vues panoramiques de jour sur la ville depuis l'emblématique forteresse médiévale perchée au-dessus de la vieille ville.",
    tag: "View",
  ...
  {
    id: "day-7",
    title: "Promenade sur la Salzach",
    description: "Promenade pittoresque le long des eaux émeraude, reliant la vieille et la nouvelle ville avec de belles vues sur les ponts.",
    tag: "Walk",
  ...
  },
  {
    id: "day-8",
    title: "Points de Vue",
    description: "Téléphérique vers le mont Untersberg pour des panoramas alpins à couper le souffle à quelques minutes du centre-ville.",
    tag: "View",
    image: "/images/salzburg_austria_his_ddc72f4b.jpg"
  }
];
...
const NIGHT_ACTIVITIES = [
  {
    id: "night-1",
    title: "Forteresse de Nuit",
    description: "Vues de la forteresse illuminée et concerts du soir à Hohensalzburg—une silhouette magique contre le ciel étoilé.",
    tag: "View",
    image: "/images/salzburg_austria_his_c717a1e9.jpg"
  },
  {
    id: "night-2",
    title: "Gastronomie",
    description: "Restaurants étoilés Michelin et cuisine locale—savourez des plats autrichiens exquis avec vues panoramiques et ambiance aux chandelles.",
    tag: "Food",
  ...
  },
  {
    id: "night-3",
    title: "Bars à Vin",
    description: "Dégustations de vins autrichiens dans des caves intimes et bars élégants, savourant le Grüner Veltliner local et spécialités régionales.",
    tag: "Food",
    image: "/images/luxury_hotel_interio_aa4bb2e2.jpg"
  },
  {
    id: "night-4",
    title: "Vieille Ville au Crépuscule",
    description: "Atmosphère magique avec rues illuminées, vitrines brillantes et charme intemporel de Salzbourg après le coucher du soleil.",
    tag: "Walk",
    image: "/images/salzburg_austria_his_ea8bfaf1.jpg"
  },
  {
    ...
    description: "Lieux du Festival de Salzbourg et musique classique—vivez des performances de classe mondiale dans des salles de concert historiques.",
    tag: "Music",
    image: "/images/salzburg_austria_mou_6393989e.jpg"
  },
  {
    id: "night-6",
    title: "Bars Rooftop",
    description: "Vues sur la ville sous les étoiles—dégustez des cocktails avec panoramas de la vieille ville illuminée et de la forteresse.",
    tag: "Nightlife",
    image: "/images/salzburg_cityscape_sunset_view.png"
  },
  {
    id: "night-7",
    title: "Clubs de Jazz",
    description: "Scène musicale live dans la vieille ville—découvrez des lieux intimes avec artistes de jazz locaux et internationaux.",
    tag: "Music",
  ...
  },
  {
    id: "night-8",
    title: "Photo de Nuit",
    description: "Meilleurs spots pour photos du soir—capturez la forteresse illuminée, reflets sur la Salzach et rues atmosphériques.",
    tag: "Photo",
    image: "/images/salzburg_austria_his_ddc72f4b.jpg"
  }
];
          ...
          <main className="app-shell">
            ...
            >
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  Ce bouton contrôle les activités affichées, indépendamment du thème global du site.
                </motion.p>
                ...
                >
                  ...
                  >
                    {isNightMode ? "Explorer au Clair de Lune" : "Découvrir en Plein Jour"}
                  </motion.span>
                </motion.div>
                ...
                >
                  {isNightMode 
                    ? "Découvrez l'atmosphère magique de Salzbourg après la tombée de la nuit—rues illuminées, lieux chaleureux et beauté intemporelle sous les étoiles."
                    : "Découvrez le charme de la ville natale de Mozart—architecture baroque, vues sur les montagnes et des siècles de culture à chaque coin."}
                </motion.p>
              </div>
            </motion.section>
            ...
            >
              ...
              >
                <h2 style={{
                  ...
                  {isNightMode ? "Favoris Nocturnes" : "Destinations Incontournables"}
                </h2>
                <p style={{
                  fontSize: "1rem",
            ...
            >
              <h3 style={{
                ...
                {isNightMode ? "Prêt à explorer la nuit ?" : "Commencez votre voyage à Salzbourg"}
              </h3>
              <p style={{
                fontSize: "1rem",
                color: isNightMode ? "#e2e8f0" : "#64748b",
