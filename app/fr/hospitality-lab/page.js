...
const principles = [
  {
    id: 1,
    title: "L'Art des Premières Impressions",
    description: "Les 30 premières secondes de toute interaction donnent le ton pour tout ce qui suit. Un sourire sincère, un contact visuel et une attention totale communiquent plus que n'importe quelle salutation répétée. L'excellence n'est pas une question de perfection — c'est une question de présence.",
    icon: (
  ...
  {
    id: 2,
    title: "Faire que les Clients se Sentent Vus",
    description: "Chaque client porte sa propre histoire, ses propres raisons d'être ici. Les meilleurs professionnels de l'hospitalité apprennent à lire entre les lignes — remarquant les petits détails qui révèlent ce dont quelqu'un a vraiment besoin, souvent avant qu'il ne le sache lui-même.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    id: 3,
    title: "Gérer les Situations Difficiles avec Grâce",
    description: "Les défis sont inévitables dans l'hospitalité. Ce qui définit un professionnel n'est pas l'absence de problèmes, mais le calme et la confiance avec lesquels ils sont résolus. Chaque plainte est une opportunité de démontrer ce que nous valorisons vraiment: l'expérience du client avant tout.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Le luxe n'est pas toujours une question de grandeur. Parfois c'est se souvenir comment un client régulier prend son café, ou remarquer quand quelqu'un semble perdu avant qu'il ne demande son chemin. Ces petits actes d'attention créent des souvenirs qui durent bien plus longtemps que n'importe quel équipement.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    id: 5,
    title: "Construire des Connexions Authentiques",
    description: "Derrière chaque enregistrement se trouve un être humain avec des espoirs pour son séjour. La différence entre un bon service et un service mémorable réside dans l'authenticité. Quand nous nous soucions sincèrement — non pas parce qu'on nous l'a appris, mais parce que nous le choisissons — les clients sentent la différence.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    id: 6,
    title: "Leçons de l'HYPERION",
    description: "Travailler à l'HYPERION Hotel Salzbourg m'a appris que la vraie hospitalité est un effort d'équipe. Chaque département, chaque collègue contribue à l'expérience du client. La réception est peut-être le visage, mais le cœur d'un hôtel bat dans chaque recoin.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.p className="hero-subtitle" variants={itemVariants}>
            Réflexions sur l'excellence du service. Leçons apprises par l'expérience, l'observation 
            et un engagement profond envers le métier de l'hospitalité.
          </motion.p>
        </motion.div>
      </motion.div>
    </section>
      ...
      <TiltCard style={{ height: "100%", position: "relative" }}>
        ...
        >
          ...
          >
            ...
            />
            Principe {index + 1} sur {principles.length}
          </motion.div>
        </motion.div>
      </TiltCard>
    </motion.div>
    ...
    <section className="app-shell" style={{ marginTop: "1rem", marginBottom: "3rem", position: "relative" }}>
      ...
      >
        ...
        <h2 style={{ fontSize: "1.6rem", fontWeight: 600, marginBottom: "0.5rem" }}>
          Les Fondements de l'Excellence
        </h2>
        <p style={{ color: "var(--color-muted)", maxWidth: "500px", margin: "0 auto" }}>
          Six principes qui guident mon approche de l'hospitalité, appris par la pratique et la réflexion.
        </p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <p style={{
            ...
            La vraie hospitalité ne consiste pas à impressionner les gens avec ce que vous avez, 
            mais à leur faire sentir qu'ils sont valorisés pour ce qu'ils sont.
          </p>
      ...
      >
        ...
        >
          ...
          <p style={{ color: "var(--color-muted)", lineHeight: 1.7, marginBottom: "1.5rem", maxWidth: "600px" }}>
            Ces principes ne sont pas des règles rigides — ce sont des idées vivantes qui évoluent avec chaque interaction, 
            chaque défi et chaque moment de croissance. Le laboratoire d'hospitalité est toujours ouvert pour de nouvelles leçons.
          </p>
          <motion.a
            href={`/${LANG}`}
