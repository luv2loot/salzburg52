...
const DINING_RECOMMENDATIONS = {
  "night-2": {
    ...
    venues: [
      "Restaurant Ikarus – 2 Michelin Stars",
      "Esszimmer – Fine Austrian Cuisine",
      "St. Peter Stiftskulinarium – Historic Setting"
    ]
  },
  "night-3": {
    title: "Wine Bar Picks",
    venues: [
      "Weinstube K+K – Local Wines",
      "Vinotek Stöckl – Curated Selection",
      "Die Weisse – Austrian Specialties"
    ]
  },
  "night-6": {
    title: "Best Rooftop Bars",
    venues: [
      "IMLAUER Sky – Panoramic Views",
      "M32 at Mönchsberg – Fortress Views",
      "Steinterrasse – Historic City Vista"
    ]
  }
};
