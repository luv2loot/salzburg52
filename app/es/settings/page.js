...
const THEME_META = {
  ...
  auto: {
    label: "Auto (Hora)",
    description: "Claro 6AM-6PM, oscuro de noche",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  light: {
    label: "Claro",
    description: "Apariencia limpia y brillante",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  "salzburg-night": {
    label: "Noche de Salzburgo",
    description: "Ambiente nocturno púrpura/azul",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        >
          <div className="settings-page-header">
            ...
            <p className="settings-page-subtitle">
              Personaliza tu experiencia con opciones de idioma, tema y accesibilidad.
            </p>
          </div>
        </motion.section>
        ...
        <section className="app-shell">
          <ScrollReveal direction="up" delay={0}>
            ...
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Idioma</h2>
            </div>
          ...
          <ScrollReveal direction="up" delay={0.1}>
            ...
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Apariencia</h2>
            </div>
            <p className="settings-page-card-desc">
              Selecciona un tema que se adapte a tu estilo.
            </p>
          ...
          <ScrollReveal direction="up" delay={0.2}>
            ...
            <div className="settings-page-card-header">
              ...
              <h2 className="settings-page-card-title">Accesibilidad</h2>
            </div>
            <p className="settings-page-card-desc">
              Ajusta la configuración para mejorar tu experiencia de navegación.
            </p>

            <div className="settings-page-option-row">
              <div className="settings-page-option-info">
                <span className="settings-page-option-label">Tamaño de Fuente</span>
            ...
            <div className="settings-page-option-row">
              <div className="settings-page-option-info">
                <span className="settings-page-option-label">Movimiento Reducido</span>
                <span className="settings-page-option-hint">
