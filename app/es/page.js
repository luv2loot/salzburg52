      ...
      <main>
        ...
        <section className="app-shell feature-root">
          <div className="surface feature-inner">
            <h2 className="feature-title">Mi Trayectoria Profesional</h2>
            ...
            <ul className="feature-list">
              <li>Aprenda de la experiencia práctica en servicio de hospitalidad de lujo.</li>
              <li>Descubra perspectivas prácticas sobre la creación de experiencias memorables para huéspedes.</li>
              <li>Explore Salzburgo desde la perspectiva de la hospitalidad profesional.</li>
            </ul>
          </div>
        </section>
        ...
        <section style={{ marginTop: "3rem" }}>
          <div className="app-shell" style={{ padding: "0 2.2rem" }}>
            <h2 style={{ fontSize: "1.4rem", fontWeight: 600, marginBottom: "2rem" }}>Salzburgo & Hospitalidad</h2>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.2rem", maxWidth: "900px", margin: "0 auto" }}>
              <div style={{ borderRadius: "14px", overflow: "hidden", aspectRatio: "1 / 1", boxShadow: "0 8px 24px rgba(15, 23, 42, 0.1)", transition: "transform 0.3s ease, boxShadow 0.3s ease", cursor: "pointer" }} onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = "0 12px 32px rgba(15, 23, 42, 0.15)"; }} onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(15, 23, 42, 0.1)"; }}>
                <img src="/images/salzburg_austria_his_ea8bfaf1.jpg" alt="Salzburgo calles históricas" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
              <div style={{ borderRadius: "14px", overflow: "hidden", aspectRatio: "1 / 1", boxShadow: "0 8px 24px rgba(15, 23, 42, 0.1)", transition: "transform 0.3s ease, boxShadow 0.3s ease", cursor: "pointer" }} onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = "0 12px 32px rgba(15, 23, 42, 0.15)"; }} onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(15, 23, 42, 0.1)"; }}>
                <img src="/images/salzburg_austria_mou_7fa6ee31.jpg" alt="Paisaje Salzburgo" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
              <div style={{ borderRadius: "14px", overflow: "hidden", aspectRatio: "1 / 1", boxShadow: "0 8px 24px rgba(15, 23, 42, 0.1)", transition: "transform 0.3s ease, boxShadow 0.3s ease", cursor: "pointer" }} onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = "0 12px 32px rgba(15, 23, 42, 0.15)"; }} onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(15, 23, 42, 0.1)"; }}>
                <img src="/images/luxury_hotel_interio_dd2a3b13.jpg" alt="Interior del hotel" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
            </div>
          </div>
        </section>
